...
.. code-block:: bash
    ...
    user@cds:~$ docker run -it consumerdatastandardsaustralia/cds-codegen-core:0.0.3-SNAPSHOT -h
...
.. code-block:: bash
   ...
   user@cds:~/git/cds-codegen/modules/cds-codegen-core$ java -jar target/cds-codegen-core-0.0.3-SNAPSHOT.jar  -h
