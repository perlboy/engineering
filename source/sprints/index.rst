...
+------------------+--------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------+----------------------+------------+
| :ref:`sprint-#3` | - Codegen Enablement     | 1) Baseline Code Generator                                                                                                                       | 22 April 2019        | In Progress|
|                  | - API 2 Code             | 2) Integrate templates into codegen (Client, Holder, Stubs)                                                                                      |                      |            |
|                  |                          | 3) Initial Payload Conformance                                                                                                                   |                      |            |
+------------------+--------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------+----------------------+------------+
| :ref:`sprint-#4` | - Authentication and     | 1) Customer API Model Definition                                                                                                                 | 06 May 2019          | Planning   |
