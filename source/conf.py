...
htmlhelp_basename = 'CDSEngineeringdoc'
...
latex_documents = [
    (master_doc, 'CDSEngineering.tex', 'CDS Engineering Documentation',
     'CSIRO Data61', 'manual'),
]
...
man_pages = [
    (master_doc, 'cdrengineering', 'CDS Engineering Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CDSEngineering', 'CDS Engineering Documentation',
     author, 'CDSEngineering', 'One line description of project.',
     'Miscellaneous'),
]
